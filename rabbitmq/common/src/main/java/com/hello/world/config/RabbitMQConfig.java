...
public class RabbitMQConfig {
     ...
     */
    public static final String RABBITMQ_DEMO_DIRECT_ROUTING = "rabbitmqDemoDirectingRouting";
    ...
    /**
     * RabbitMQ的HEADER_EXCHANGE交换机的名称
     */
    public static final String HEADER_EXCHANGE_NAME = "header.exchange.name";

    /**
     * RabbitMQ的HEADER_EXCHANGE交换机的队列A的名称
     */
    public static final String HEADER_EXCHANGE_QUEUE_A = "header.queue.a";

    /**
     * RabbitMQ的HEADER_EXCHANGE交换机的队列B的名称
     */
    public static final String HEADER_EXCHANGE_QUEUE_B = "header.queue.b";
